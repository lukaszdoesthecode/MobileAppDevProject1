...
/**
 * Adapter for displaying upcoming vaccination appointments in a RecyclerView.
 * This adapter takes a list of [DataVaxx] objects and displays them in the RecyclerView.
 * It also provides filtering functionality to search for specific appointments.
 * @param upcomingList The list of upcoming vaccination appointments to be displayed.
 */
class AdapterUpcoming(private val upcomingList: List<DataVaxx>) :
    ...
    /**
     * Returns a Filter object that can be used to filter the list of items.
     */
    ...
    /**
     * Updates the Firestore database with the new values of the [DataVaxx] object.
     */
    ...
    /**
     * Deletes an item from the list and Firestore database.
     */
